...
-- checking the type signature of length in GHC 7.10, you will find
...
-- though list is only one of the possible types. We will explain it in
-- detail later.)
...
-- 8. Write a function that tells you whether or not a given String
-- (or list) is a palindrome. Here you’ll want to use a function called
